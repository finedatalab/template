 ...
 <script>
	...
	function LoadPage() {		
		...
		sheet_init.Cols = [		
		       			...
		       			{Header:"<fmt:message>header.carmodelcode</fmt:message>",	Type:"Text", KeyField:1, Width:100, SaveName:"CarModelCode", Align:"Center"},
		       			{Header:"<fmt:message>header.carmodelname</fmt:message>",	Type:"Text", Width:200, SaveName:"CarModelName", Align:"Left"},
		       			{Header:"<fmt:message>header.createdate</fmt:message>",	Type:"Text", Width:100, SaveName:"CreateDate", Align:"Center", Format:"yyyy-MM-dd"},
		       			{Header:"<fmt:message>header.createsawon</fmt:message>",	Type:"Text", Width:100, SaveName:"CreateSawon", Align:"Center"},
		       			{Header:"<fmt:message>header.updatedate</fmt:message>",	Type:"Text", Width:100, SaveName:"UpdateDate", Align:"Center", Format:"yyyy-MM-dd"},
		       			{Header:"<fmt:message>header.updatesawon</fmt:message>",	Type:"Text", Width:100, SaveName:"UpdateSawon", Align:"Center"},
		       		]; 
...
<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>Home</li><li><fmt:message>menu.claim</fmt:message></li><li><fmt:message>menu.basicinfo</fmt:message></li><li><fmt:message>menu.carmodel</fmt:message></li>
				</ol>
				<!-- end breadcrumb -->
									...
									<form name="myform">
										<div class="row">
											...
											<div class="col-sm-6" style="margin-bottom:5px;">
												<button type="button" class="btn btn-sm btn-success pull-right" style="margin-right: 5px;" onclick ="javascript:doAction('templetedown')"><i class="fa fa-file-excel-o"></i> <fmt:message>button.down</fmt:message></button>
                             					<button type="button" class="btn btn-sm btn-success pull-right" style="margin-right: 5px;" onclick ="javascript:doAction('loadexcel')"><i class="fa fa-file-excel-o"></i> <fmt:message>button.upload</fmt:message></button>
